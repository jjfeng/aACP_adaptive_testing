...
def parse_args():
    ...
    parser.add_argument("--train-seed", type=int, default=1235, help="seed")
    parser.add_argument("--meta-seed", type=int, default=0, help="seed")
...
def main():
    ...
    full_dat, beta_time_varying = data_generator.generate_data(
        args.init_train_n,
        args.train_batch_n,
        args.train_iters,
        ...
        train_batch_incr_factor=args.train_incr_factor,
    )
